...
export default function ParticleBackground() {
  ...
  useEffect(() => {
    ...
    const particleCount = Math.min(30, window.innerWidth / 15);

    // Initialize particles - positioned around edges
    ...
    const animate = () => {
      ...
      particles.forEach((particle) => {
        ...
        // Mouse attraction - reduced intensity
        ...
        ctx.fillStyle = `rgba(147, 51, 234, ${particle.opacity * 0.6})`;
        ctx.beginPath();
